    ...
    <section className="min-h-screen bg-white flex items-center justify-center px-4 py-20">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          >
            Analyze your resume, detect missing skills, and improve job match
            instantly. Get ahead of the competition with AI-powered insights.
          </motion.p>
          ...
          <motion.div
            variants={itemVariants}
            className="flex gap-8 pt-6 text-sm font-semibold"
          >
            <div>
        ...
        >
          <div className="absolute inset-0 bg-gray-100 border-[3px] border-black flex items-center justify-center overflow-hidden">
